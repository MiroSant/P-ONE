This simulation generates Muon Neutrinos from 10 TeV to 10 PeV using Lepton Weighter, then the photons are propagated by CLSIM through different geometries
